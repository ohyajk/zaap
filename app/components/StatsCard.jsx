const StatsCard = ({name, duration, count, bgColor, image}) => {
    return (
        <div className="w-full max-w-[166px] px-4 py-3 rounded-3xl relative overflow-hidden" style={{background: `${bgColor}`}}>
