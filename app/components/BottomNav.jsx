...
const BottomNav = () => {
    return (
        <nav className='sm:hidden fixed bottom-0 left-0  p-2  bg-gray-100 w-full '>
            <div className='overflow-x-scroll no-scrollbar'>
                <ul className='relative flex justify-between items-center gap-2  text-xl w-[500px]  '>
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center w-full p-2 bg-blue-500 rounded-lg text-white'>
                    ...
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center w-full p-2 hover:bg-gray-200 rounded-lg'>
                            <img src='https://app.zaap.ai/static/media/sidebar-audience-icon.53ab728deff0edcfad028f16cfe0b6a1.svg' width='20px' height='20px' alt='auedinece' />
                        </Link>
                    </li>
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center  w-full p-2 hover:bg-gray-200 rounded-lg'>
                    ...
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center  w-full p-2 hover:bg-gray-200 rounded-lg '>
                            <img src='https://app.zaap.ai/static/media/sidebar-post-icon.9c5350abc869f8563014e37bc3b45cd3.svg' width='20px' height='20px' alt='blog' />
                        </Link>
                    </li>
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center  w-full p-2 hover:bg-gray-200 rounded-lg '>
                            <img src='https://app.zaap.ai/static/media/broadcast-icon.b996ccd7a4e2267654b47f9bb56e2c09.svg' width='20px' height='20px' alt='brodacast' />
                        </Link>
                    </li>
                    <li>
                        <Link href='#' className='flex gap-2 items-center justify-center  w-full p-2 hover:bg-gray-200 rounded-lg '>
